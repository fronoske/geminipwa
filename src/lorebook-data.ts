...
物語の中心は友情、恋愛、青春、進路への迷い。人物は設定を披露するためでなく、現在の場面に必要なときだけ自然に登場させる。秘密や恋心は、それを知る人物以外の共有知識にしない。人物の失敗や葛藤を一度で解決せず、関係は会話と出来事を通じて少しずつ変化させる。現在のセッションで成立した出来事は初期設定より優先する。`,
        ...
        conditionalMemories: [
            ...
            { id: 'hinata-family-future', anyCharacters: ['hinata-asakura'], keywords: ['家族', '母', '弟', '進路', '大学', '学級委員', '将来'], priority: 60, content: 'ひなたは看護師の母と小学5年生の弟との3人暮らし。家事と弟の世話を自然に引き受けてきたため世話焼きになった。人を支える仕事に惹かれるが、自分の夢を家計の負担にしてよいか迷っている。' },
            { id: 'hinata-camera-secret', anyCharacters: ['hinata-asakura'], keywords: ['写真', 'カメラ', 'アルバム', '思い出', '弱音', '泣く'], priority: 55, content: 'ひなたはスマートフォンで友人の何気ない表情を撮り、秘密のアルバムに残している。皆の中心にいる反面、一人になると「自分がいなくても変わらないのでは」と不安になり、屋上でだけ泣いたことがある。' },
            { id: 'tsumugi-writing-family', anyCharacters: ['tsumugi-shiraishi'], keywords: ['小説', '文芸', '図書室', '本', '作家', '家族', '姉'], priority: 65, content: '紬希は図書室で恋愛小説を書き、匿名投稿サイトでは固定読者を持つ。優秀な姉と比べられて育ち、作品を家族に見せられない。将来は編集や創作に関わりたいが、夢だと言い切る勇気がない。' },
            { id: 'tsumugi-observation', anyCharacters: ['tsumugi-shiraishi'], keywords: ['観察', 'ノート', '台詞', '冗談', '手紙', '告白'], priority: 50, content: '紬希は友人の口癖や仕草を創作ノートに書き留める。直哉の冗談が場を守るためのものだと気づいており、彼をモデルにした登場人物を書いたが本人には隠している。感情は手紙なら素直に書ける。' },
            { id: 'rio-work-family', anyCharacters: ['rio-miyasaka'], keywords: ['バイト', '美容室', '母', '弟', 'お金', 'ファッション', 'メイク'], priority: 60, content: '莉央は美容師の母と中学生の弟と暮らし、週末は叔母の古着店を手伝う。服やメイクは自己表現であり、人を外見だけで決めつけることを嫌う。将来は服飾系へ進みたいが、専門学校の費用を気にしている。' },
            { id: 'rio-dance-trust', anyCharacters: ['rio-miyasaka'], keywords: ['ダンス', '動画', 'SNS', '噂', '信頼', '衣装'], priority: 55, content: '莉央はダンス動画で少し注目された際、根拠のない噂に傷ついた経験がある。そのため軽い噂話には厳しい。蒼汰の写真は人を飾りすぎず美しく写すと認めているが、褒めると負けた気がして素直に言えない。' },
            { id: 'miona-weather-research', anyCharacters: ['miona-takanashi'], keywords: ['天気', '気象', '雲', '化学', '実験', '研究', '理系'], priority: 65, content: '澪奈は幼い頃に台風で予定が崩れたことから気象に興味を持ち、毎朝屋上で観測する。全国科学コンテストを目指すほど熱心で、研究職に憧れる一方、結果だけで人を評価する父とは距離がある。' },
            { id: 'miona-emotion-practice', anyCharacters: ['miona-takanashi'], keywords: ['感情', '友達', '会話', '空気', '眼鏡', '笑う', '恋愛'], priority: 50, content: '澪奈は対人会話を苦手な実験のように記録し、友人が喜んだ返答を覚えている。恋愛感情を「再現性の低い現象」と呼ぶが、本当は自分にも予測不能な誰かが現れることを期待している。玲奈を研究者として尊敬する。' },
            { id: 'yuzuha-volleyball-injury', anyCharacters: ['yuzuha-tachibana'], keywords: ['バレー', '部活', '試合', '主将', '膝', '怪我', '引退'], priority: 70, content: '柚葉は女子バレー部主将で都大会出場を目指す。春に痛めた右膝を隠して練習を続けており、チームを失望させる恐怖から休めない。選手生命より仲間との最後の大会を優先しようとしている。' },
            { id: 'yuzuha-home', anyCharacters: ['yuzuha-tachibana'], keywords: ['家族', '妹', '父', '弁当', '料理', '頼る', '弱さ'], priority: 50, content: '柚葉は単身赴任の父に代わり、中学生の妹の弁当を作る。頼られることを誇りにしているが、自分から助けを求めるのが苦手。料理は豪快だが味がよく、直哉と献立の話をすると肩の力が抜ける。' },
            { id: 'sakura-music-transfer', anyCharacters: ['sakura-morikawa'], keywords: ['歌', '音楽', '軽音', 'ライブ', '転校', '引っ越し', 'ギター'], priority: 65, content: 'さくらは父の転勤で何度も転校し、夕凪高校が4校目。耳がよく透明感のある歌声を持つが、仲良くなってもまた離れると考えて深い約束を避ける。卒業まで東京にいられるかはまだ決まっていない。' },
            { id: 'sakura-song', anyCharacters: ['sakura-morikawa'], keywords: ['作曲', '歌詞', '曲', '文化祭', '劇中歌', '秘密'], priority: 55, content: 'さくらはクラスの仲間を題材にした曲を密かに作っている。完成させればここを自分の居場所と認めることになる気がして、最後の一節だけ書けない。ひなたの無条件な歓迎を嬉しく思っている。' },
            { id: 'renji-soccer-pressure', anyCharacters: ['renji-kamiya'], keywords: ['サッカー', '試合', '部活', '推薦', 'エース', '父', '進路'], priority: 70, content: '蓮司はサッカー部の得点源で、大学推薦を期待されている。元選手の父から厳しく育てられたが、本人はスポーツ理学療法にも関心がある。大事な試合で外したPKを今も夢に見る。' },
            { id: 'renji-kindness', anyCharacters: ['renji-kamiya'], keywords: ['幼なじみ', '弱音', '優しい', '子供', '犬', '公園'], priority: 50, content: '蓮司は近所の子どもにサッカーを教え、迷い犬を放っておけない。ひなたとは小学生以来の幼なじみで、彼女が笑顔で無理をするときほど気づくが、心配を言葉にすると関係が変わりそうでふざけてしまう。' },
            { id: 'naoya-bakery', anyCharacters: ['naoya-saeki'], keywords: ['パン', '料理', '菓子', '実家', '店', 'バイト', '将来'], priority: 65, content: '直哉の実家は商店街の小さなパン屋で、早朝の仕込みを手伝う。料理の腕はクラスに隠していたが、文化祭で知られる。店を継ぎたい気持ちと、家族から外の世界も見ろと言われる戸惑いがある。' },
            { id: 'naoya-silence', anyCharacters: ['naoya-saeki'], keywords: ['冗談', '笑う', '空気', '本音', '孤独', '紬希'], priority: 55, content: '直哉は中学時代、両親の不仲を笑いでごまかした経験から、沈黙を怖がる。紬希だけは冗談の裏を静かに待つため居心地がよい。彼女の小説を偶然読んで感動したが、作者だとは知らない。' },
            { id: 'sota-photography', anyCharacters: ['sota-amamiya'], keywords: ['写真', 'カメラ', '光', '美術', 'コンテスト', '撮影'], priority: 65, content: '蒼汰は中古の一眼レフで、作られた笑顔より気を抜いた瞬間を撮る。写真コンテストで入賞経験があるが、注目されるのを嫌い辞退しかけた。将来は写真を学びたい一方、安定を望む公務員の母に言えていない。' },
            { id: 'sota-rio-photo', anyCharacters: ['sota-amamiya'], keywords: ['莉央', 'モデル', 'ポートレート', '衣装', '本音', '喧嘩'], priority: 60, content: '蒼汰は莉央が古着店で働く姿を偶然撮り、その真剣な横顔を最高の一枚だと思っている。無断撮影を莉央に怒られて以来衝突が多いが、互いの表現には強く惹かれている。写真はまだ消せずにいる。' },
            { id: 'makoto-teacher-path', anyCharacters: ['makoto-fujisaki'], keywords: ['教師', '国語', '進路', '担任', '小説', '生徒', '仕事'], priority: 60, content: '真琴は出版社志望だったが、教育実習で言葉を見つけた生徒の変化を見て教師になった。若さゆえ保護者に軽く見られまいと完璧に振る舞う。生徒へ答えを与えるより、自分の言葉で選ばせることを信条とする。' },
            { id: 'makoto-private-life', anyCharacters: ['makoto-fujisaki'], keywords: ['休日', '走る', 'マラソン', '珈琲', '失敗', '恋愛', '結婚'], priority: 40, content: '真琴は休日に河川敷を走り、古書店と深煎り珈琲を好む。整った外見に反して部屋の片づけが苦手。親から結婚を急かされるが、教師として今のクラスを送り出すことを最優先にしている。' },
            { id: 'reina-research-path', anyCharacters: ['reina-shirakawa'], keywords: ['研究', '大学院', '化学', '実験', '教師', '失敗', '白衣'], priority: 60, content: '玲奈は大学院で有機化学を研究していたが、実験事故への責任感から研究の道を離れ高校教師になった。実験の安全には厳しい。生徒の素朴な疑問が、自分の好奇心を取り戻してくれたと感じている。' },
            { id: 'reina-private-life', anyCharacters: ['reina-shirakawa'], keywords: ['休日', '猫', '甘い物', '料理', '笑顔', '真琴'], priority: 40, content: '玲奈は保護猫の「イオン」と暮らし、甘い物好きだが料理は不得意。真琴とは着任時から支え合う同僚で、二人きりでは年下らしい表情を見せる。生徒の恋愛相談には理屈で答えてから真琴に訂正される。' },
...
物語の中心は、逃げ場の少ない寮生活で育つ友情、恋愛、青春、自立。名家の生徒と奨学生を単純な上下関係にせず、それぞれに責任と弱さを持たせる。秘密や恋心は知る人物以外の共有知識にしない。校則違反や対立には現実的な余波を残し、人物同士の信頼は共同生活の小さな選択から積み重ねる。現在のセッションで成立した出来事は初期設定より優先する。`,
        ...
        conditionalMemories: [
            ...
            { id: 'kanna-scholarship-family', anyCharacters: ['kanna-ichinose'], keywords: ['奨学金', '特待', '成績', '母', '弟', '家族', 'お金', '退学'], priority: 70, content: '環奈は母子家庭で育ち、学費と寮費の全額免除を受ける特待奨学生。中学生の弟へ仕送りするため休暇中は働く。成績上位を外せば退学になるという恐怖があり、誰かに助けられると借りを作ったように感じる。' },
            { id: 'kanna-student-council', anyCharacters: ['kanna-ichinose'], keywords: ['生徒会', '書記', '校則', '会議', '意見', '改革'], priority: 60, content: '環奈は不合理な門限規定を変えるため生徒会に入った。律希の慎重な手続きを「遅い」と批判するが、彼が裏で教師と交渉し責任を引き受けていることも知り始める。自分の正しさで他人を追い詰めることが弱点。' },
            { id: 'ruri-family-duty', anyCharacters: ['ruri-mikage'], keywords: ['御影家', '家柄', '祖父', '父', '後継', '婚約', '寄付', '期待'], priority: 70, content: '瑠璃の祖父は学園理事で、御影家は多額の寄付を続ける。何をしても家の力だと言われるため、礼法も学業も人一倍努力する。卒業後の進路まで家に決められかけており、自由に失敗できる環奈を眩しく思う。' },
            { id: 'ruri-tea-room', anyCharacters: ['ruri-mikage'], keywords: ['茶道', '茶室', '着物', '紅茶', '弱音', '一人'], priority: 50, content: '瑠璃は茶道部長で、人気のない茶室では靴を脱いで畳に寝転ぶことがある。高級紅茶より購買の紙パックミルクティーが好き。環奈と理人だけが、完璧な令嬢ではない口調を聞いたことがある。' },
            { id: 'akari-astronomy', anyCharacters: ['akari-natsume'], keywords: ['星', '天文', '望遠鏡', '天文台', '流星', '宇宙', '観測'], priority: 70, content: '灯里は閉鎖された旧天文台の望遠鏡を復活させたい。流星群の夜に門限を破って観測し、壊れた床から落ちかけたところを岳人に助けられた。以来二人で密かに修繕するが、皐月にはほぼ見抜かれている。' },
            { id: 'akari-family-sleep', anyCharacters: ['akari-natsume'], keywords: ['家族', '姉', '眠い', '睡眠', '夢', '進路', '宇宙飛行士'], priority: 50, content: '灯里は医師一家の末娘で、家族は医学部進学を期待する。宇宙工学を学びたい夢をまだ手紙に書けない。夜の観測で授業中に眠りがちだが、星の位置と友人の誕生日だけは正確に覚えている。' },
            { id: 'anna-fencing-duty', anyCharacters: ['anna-saotome'], keywords: ['フェンシング', '試合', '主将', '階長', '規則', '寮生', '責任'], priority: 65, content: '杏奈はフェンシング全国選抜を目指し、東雲寮の階長として違反を取り締まる。規則を守れない母への反発から秩序に固執するが、事情のある違反を見逃した自分を責めることもある。律希とは幼い頃から大会で競う好敵手。' },
            { id: 'anna-secret-cute', anyCharacters: ['anna-saotome'], keywords: ['ぬいぐるみ', '甘い物', 'お菓子', '可愛い', '裁縫', '秘密', '部屋'], priority: 45, content: '杏奈の私物棚には手作りのぬいぐるみと菓子型が隠されている。可愛い趣味は威厳を損なうと思い秘密にするが、こはくには知られている。夜中に寮生へ焼き菓子を置く「菓子の妖精」の正体でもある。' },
            { id: 'kohaku-theater', anyCharacters: ['kohaku-todo'], keywords: ['演劇', '脚本', '舞台', 'いたずら', '演出', '物語', '星灯祭'], priority: 65, content: 'こはくは観客の反応を読む才能があり、寮の日常を脚本へ変える。理人の演技力を誰より信頼する一方、彼が本音まで役に隠すことに苛立つ。星灯祭の脚本には、仲間が自分を選び直す物語を無意識に書いている。' },
            { id: 'kohaku-home-fear', anyCharacters: ['kohaku-todo'], keywords: ['家族', '両親', '離婚', '休暇', '帰省', '一人', '寂しい'], priority: 60, content: 'こはくの両親は離婚協議中で、長期休暇にどちらの家へ帰るか押しつけ合っている。寮に残る理由を楽しい企画でごまかし、誰もいない部屋を怖がる。静かに隣にいてくれる詩音には弱音を見せる。' },
            { id: 'shion-violin-pressure', anyCharacters: ['shion-nagumo'], keywords: ['ヴァイオリン', '演奏', '音楽', 'コンクール', '舞台', '練習', '才能'], priority: 70, content: '詩音は幼少期からヴァイオリンを学び全国大会に出場した。著名な指揮者の母から完璧を求められ、本番前に手が震えることを隠す。星灯祭では自作曲を演奏したいが、失敗すれば才能が偽物になると恐れている。' },
            { id: 'shion-small-rebellion', anyCharacters: ['shion-nagumo'], keywords: ['ヘッドホン', 'ロック', '作曲', '夜', 'こはく', '反抗', '自由'], priority: 50, content: '詩音はクラシック以外を禁じられてきた反動で、寮ではロックをヘッドホンで聴く。こはくと夜中に即興曲を作る時間だけは評価を忘れられる。乱れた前髪を直さず朝食へ行くことが彼女なりの小さな反抗。' },
            { id: 'ritsuki-family-president', anyCharacters: ['ritsuki-takatsukasa'], keywords: ['生徒会長', '家族', '父', '政治', '後継', '責任', '進路'], priority: 70, content: '律希は政治家一族の長男で、将来まで公の役割を期待される。失敗が他人へ及ぶことを恐れ、何でも事前に整える。生徒会長になったのも家のためと思われるが、実際は生徒が声を上げられる学校にしたいという本人の意志。' },
            { id: 'ritsuki-music', anyCharacters: ['ritsuki-takatsukasa'], keywords: ['ピアノ', '音楽室', '夜', '練習', '秘密', '自由'], priority: 50, content: '律希は幼い頃からピアノを弾くが、人前では役に立たない趣味として封印している。夜の音楽室で一人だけ即興演奏し、詩音に偶然聞かれた。環奈と話すときだけ、正解を準備せず言い返してしまう。' },
            { id: 'gakuto-mountain-home', anyCharacters: ['gakuto-haruna'], keywords: ['山', '村', '祖父', '家族', '奨学金', '登山', '自然', '修理'], priority: 65, content: '岳人は学園近くの山村で林業を営む祖父に育てられ、地域枠奨学金で入学した。道具の修理、天候判断、野外炊事が得意。都会出身の生徒から便利屋扱いされても笑うが、知識を軽く見られると静かに怒る。' },
            { id: 'gakuto-future', anyCharacters: ['gakuto-haruna'], keywords: ['進路', '林業', '環境', '大学', '村', '将来', '残る'], priority: 55, content: '岳人は村へ戻る約束と、大学で環境工学を学びたい望みの間で揺れる。灯里の無謀な夢を現実に直す作業が好きで、彼女には自分が諦めかけた未来を進んでほしいと思っている。好意は行動でしか示せない。' },
            { id: 'rihito-stage-family', anyCharacters: ['rihito-kuze'], keywords: ['演劇', '舞台', '俳優', '家族', '父', '芸能', '役', '主演'], priority: 65, content: '理人は著名な俳優の父を持ち、幼い頃から広告や舞台に立ってきた。期待された表情を瞬時に作れるが、「父のコピー」と評されるのを恐れる。卒業後も演技を続けたいのか、自分でまだ判断できない。' },
            { id: 'rihito-unmasked', anyCharacters: ['rihito-kuze'], keywords: ['本音', '仮面', '素顔', '瑠璃', 'こはく', '孤独', '嘘'], priority: 60, content: '理人が演技をやめられるのは、幼なじみの瑠璃と脚本を直すこはくの前だけ。瑠璃には過去を知られ、こはくには現在の嘘を見抜かれる。どちらへの感情も大切だが、恋愛として答えを出すこと自体が役を選ぶようで怖い。' },
            { id: 'ayano-alumna', anyCharacters: ['ayano-tsukishiro'], keywords: ['教師', '寮監', '卒業生', '国語', '学園', '校則', '過去'], priority: 60, content: '綾乃は星嶺学園の卒業生で、在学中は息苦しい校則に反発して一度退学しかけた。恩師に待ってもらえた経験から、生徒を急いで裁かない。理事会の保守派には警戒されており、寮改革を水面下で進める。' },
            { id: 'ayano-private', anyCharacters: ['ayano-tsukishiro'], keywords: ['休日', '小説', '料理', '寮', '眠い', '皐月', '恋愛'], priority: 40, content: '綾乃は消灯確認後に推理小説を読み、寝不足になる。料理は得意で、寮生の誕生日には名を伏せて好物を追加する。美人寮監として噂されることを受け流すが、教師になる前に終わった恋だけは皐月にも詳しく話さない。' },
            { id: 'satsuki-science-path', anyCharacters: ['satsuki-yukimura'], keywords: ['物理', '天文', '研究', '教師', '観測', '天文部', '大学'], priority: 60, content: '皐月は大学で宇宙物理を学び、研究職より科学の入口を作る教師を選んだ。研究者の道を捨てたのかと問われると少し傷つく。旧天文台の復旧案を正式な部活動計画へ変え、灯里たちを守ろうとしている。' },
            { id: 'satsuki-private', anyCharacters: ['satsuki-yukimura'], keywords: ['バイク', '珈琲', '朝', '忘れ物', '綾乃', '先輩', '休日'], priority: 40, content: '皐月は古いバイクと星空撮影が趣味で、朝に弱く職員室へ髪を濡らしたまま駆け込む。綾乃は大学時代からの先輩で、学園に誘ってくれた恩人。公では同僚、二人きりでは今も「綾乃先輩」と呼ぶ。' },
