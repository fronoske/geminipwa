...
const getRequiredDomElement = (id: string): HTMLElement => {
  ...
  return element;
        ...
        const elements = {
            ...
            lorebookEditorScreen: document.getElementById('lorebook-editor-screen'),
            ...
            enableCommonDummyModelFollowupUserCheckbox: document.getElementById('enable-common-dummy-model-followup-user'),
...
elevationHoverOption: document.getElementById('elevation-hover-option'),
    ...
    appVersionSpan: document.getElementById('app-version'),
            ...
            headerMenuStringReplacementBtn: document.getElementById('header-menu-string-replacement-btn'),
            ...
            stringReplacementDialog: getRequiredDomElement('string-replacement-dialog'),
            stringReplacementForm: getRequiredDomElement('string-replacement-form'),
            stringReplacementSearch: getRequiredDomElement('string-replacement-search'),
            stringReplacementReplacement: getRequiredDomElement('string-replacement-replacement'),
            stringReplacementScopeAll: getRequiredDomElement('string-replacement-scope-all'),
            stringReplacementScopeEditing: getRequiredDomElement('string-replacement-scope-editing'),
            stringReplacementModeBatch: getRequiredDomElement('string-replacement-mode-batch'),
            stringReplacementModeSequential: getRequiredDomElement('string-replacement-mode-sequential'),
            stringReplacementCancelBtn: getRequiredDomElement('string-replacement-cancel-btn'),
            stringReplacementBar: getRequiredDomElement('string-replacement-bar'),
            stringReplacementPrompt: getRequiredDomElement('string-replacement-prompt'),
            stringReplacementProgress: getRequiredDomElement('string-replacement-progress'),
            stringReplacementAllBtn: getRequiredDomElement('string-replacement-all-btn'),
            stringReplacementYesBtn: getRequiredDomElement('string-replacement-yes-btn'),
            stringReplacementNoBtn: getRequiredDomElement('string-replacement-no-btn'),
            stringReplacementPreviousBtn: getRequiredDomElement('string-replacement-previous-btn'),
            stringReplacementNextBtn: getRequiredDomElement('string-replacement-next-btn'),
            stringReplacementStopBtn: getRequiredDomElement('string-replacement-stop-btn'),
            ...
            addLorebookBtn: getRequiredDomElement('add-lorebook-btn'),
            importLorebooksBtn: getRequiredDomElement('import-lorebooks-btn'),
            importLorebooksInput: getRequiredDomElement('import-lorebooks-input'),
            exportAllLorebooksBtn: getRequiredDomElement('export-all-lorebooks-btn'),
            lorebookManagementList: getRequiredDomElement('lorebook-management-list'),
            noLorebooksMessage: getRequiredDomElement('no-lorebooks-message'),
            backFromLorebookEditorBtn: getRequiredDomElement('back-from-lorebook-editor'),
            lorebookEditorTitle: getRequiredDomElement('lorebook-editor-title'),
            lorebookEditorProviderRow: getRequiredDomElement('lorebook-editor-provider-row'),
            lorebookAnalysisProvider: getRequiredDomElement('lorebook-analysis-provider'),
            lorebookEditorInstructions: getRequiredDomElement('lorebook-editor-instructions'),
            lorebookEditorFileActions: getRequiredDomElement('lorebook-editor-file-actions'),
            loadLorebookSourceBtn: getRequiredDomElement('load-lorebook-source-btn'),
            lorebookSourceFileInput: getRequiredDomElement('lorebook-source-file-input'),
            lorebookStructuredEditorToolbar: getRequiredDomElement('lorebook-structured-editor-toolbar'),
            toggleLorebookJsonEditorBtn: getRequiredDomElement('toggle-lorebook-json-editor-btn'),
            lorebookStructuredForm: getRequiredDomElement('lorebook-structured-form'),
            lorebookEditorTextareaLabel: getRequiredDomElement('lorebook-editor-textarea-label'),
            lorebookSourceTextarea: getRequiredDomElement('lorebook-source-textarea'),
            lorebookAnalysisProgress: getRequiredDomElement('lorebook-analysis-progress'),
            lorebookAnalysisProgressCount: getRequiredDomElement('lorebook-analysis-progress-count'),
            lorebookAnalysisProgressCurrent: getRequiredDomElement('lorebook-analysis-progress-current'),
            lorebookAnalysisProgressPhases: getRequiredDomElement('lorebook-analysis-progress-phases'),
            lorebookEditorStatus: getRequiredDomElement('lorebook-editor-status'),
            toggleLorebookAnalysisLogBtn: getRequiredDomElement('toggle-lorebook-analysis-log-btn'),
            lorebookAnalysisLogDialog: getRequiredDomElement('lorebook-analysis-log-dialog'),
            closeLorebookAnalysisLogBtn: getRequiredDomElement('close-lorebook-analysis-log-btn'),
            lorebookAnalysisLog: getRequiredDomElement('lorebook-analysis-log'),
            analyzeLorebookBtn: getRequiredDomElement('analyze-lorebook-btn'),
            lorebookAnalysisDialog: getRequiredDomElement('lorebookAnalysisDialog'),
            lorebookAnalysisReport: getRequiredDomElement('lorebook-analysis-report'),
            lorebookAnalysisResultTextarea: getRequiredDomElement('lorebook-analysis-result'),
            lorebookAnalysisCancelBtn: getRequiredDomElement('lorebook-analysis-cancel-btn'),
            lorebookAnalysisSaveBtn: getRequiredDomElement('lorebook-analysis-save-btn'),
            responseDetailsDialog: getRequiredDomElement('response-details-dialog'),
            closeResponseDetailsBtn: getRequiredDomElement('close-response-details-btn'),
            responseDetailsModel: getRequiredDomElement('response-details-model'),
            responseDetailsFinish: getRequiredDomElement('response-details-finish'),
            responseDetailsTokens: getRequiredDomElement('response-details-tokens'),
            responseDetailsLorebookStatus: getRequiredDomElement('response-details-lorebook-status'),
            responseDetailsLorebookSize: getRequiredDomElement('response-details-lorebook-size'),
            responseDetailsLorebookReference: getRequiredDomElement('response-details-lorebook-reference'),
            copyResponseLorebookBtn: getRequiredDomElement('copy-response-lorebook-btn'),
